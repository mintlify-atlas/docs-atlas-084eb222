---
title: "Back Up and Restore the WhatsApp Session"
sidebarTitle: "Session Backup"
description: "Piumy can encrypt and back up the WhatsApp session database. Restore from backup with the pimywa restore-session CLI command when the session is corrupt or lost."
---
