---
title: "Set Up and Rotate the MCP Bearer Token Auth on Piumy"
sidebarTitle: "MCP Auth"
description: "Piumy's MCP endpoint is fail-closed: all requests are rejected until a bearer token is set. Run pimywa auth setup to generate and save your token."
---
