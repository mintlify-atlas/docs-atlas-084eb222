---
title: "Link a WhatsApp Number to Piumy via QR Code Pairing"
sidebarTitle: "Connect WhatsApp"
description: "Link a dedicated WhatsApp number to Piumy by scanning the QR code from the dashboard. Session credentials are stored locally and persist across restarts."
---
