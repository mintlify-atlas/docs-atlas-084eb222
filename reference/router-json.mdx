---
title: "router.json: Piumy Whitelist and Routing Configuration"
sidebarTitle: "router.json"
description: "router.json controls which JIDs reach the switchboard and how they are routed. Supports exact matches and wildcard rules with mode and plugin overrides."
---
