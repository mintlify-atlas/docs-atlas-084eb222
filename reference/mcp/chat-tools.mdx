...
description: "MCP tools for browsing chats, reading per-chat state, managing triage status, claiming/releasing chats for multi-agent coordination, and setting memory and context."
---

These 11 MCP tools manage the chat layer — browsing, reading, triaging, and coordinating between multiple agents. They cover everything from scanning for pending conversations to locking a chat so two agents don't work it simultaneously.
