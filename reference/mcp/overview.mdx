---
title: "MCP Tools Overview: All 23 Piumy Tools"
sidebarTitle: "Overview"
description: "Piumy exposes 23 MCP tools for AI agents to read chats, manage the queue, send replies, and perform admin operations. The endpoint is fail-closed — requires a bearer token."
---
